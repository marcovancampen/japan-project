...
<div class="page-wrapper with-navbar with-sidebar">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="delete.php" class="sidebar-link active"> <em class="fas fa-info-circle"> </em> delete profile</a>
            <a href="update.php" class="sidebar-link"> <em class="fas fa-info-circle"> </em> update profile</a>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
         ...
         <div class="card">
            ...
            <form action="delete.php" method="post" class="w-400 mw-full" enctype="multipart/form-data">
                ...
                <input class="btn btn-primary btn-block" type="submit" name="delete" value="submit">
...
<script src="halfmoon/js/halfmoon.min.js"></script>
    ...
    if (isset($_POST['delete'])) {
        ...
        if (password_verify($password, $pass['password'])){
            $sql2 = "DELETE FROM user WHERE  username = ?";
