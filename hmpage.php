...
<div class="page-wrapper with-navbar with-sidebar">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="hmpage.php" class="sidebar-link active"> <em class="fas fa-home"> </em> Home</a>
    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <h3 class="card-title">
                <form action="hmpage.php" method="post" class="w-400 mw-full">
                    <input type="text" class="form-control" placeholder="intership" name="searchresult">
                    <br>
        ...
        <div class="card">
            <h3 class="card-title">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "SELECT companyname, street_address, postal_code FROM company where companyname LIKE CONCAT('%',?,'%') OR street_address LIKE CONCAT('%',?,'%') OR postal_code LIKE CONCAT('%',?,'%')";
